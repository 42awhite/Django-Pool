...
class Text(str):
    ...
    def __str__(self):
        ...
        """
        # IMPORTANTE: He añadido el escapado de <, >, " y & para pasar tests.py
        # El esqueleto original solo sugería el replace de \n
...
class Elem:
    ...
    """
    #[...] Definición de la excepción interna
    class ValidationError(Exception):
        def __init__(self):
            super().__init__("Invalid HTML element content.")
    ...
    def __str__(self):
        ...
        """
        result = ""
        # [...] -> Lógica para etiquetas dobles y simples
    ...
    def __make_content(self):
        ...
        for elem in self.content:
            #[...] La "magia" de la indentación recursiva. Convertimos a string e indentamos cada línea nueva con 2 espacios
            indented = str(elem).replace('\n', '\n  ')
            result += f"  {indented}\n"
        return result
